...
if (-not $BuildDir) {
    $BuildDir = Join-Path $Root "build\phase1_cdc"
}
...
cmake --build $BuildDir --target pico_h_phase1_cdc

$Bin = Join-Path $BuildDir "pico_h_phase1_cdc.bin"
$Uf2 = Join-Path $BuildDir "pico_h_phase1_cdc.uf2"
